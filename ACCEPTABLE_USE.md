...
MediaHelm Live is self-hosted software that acts as a tuner bridge for personal media
servers (Plex, Jellyfin, Emby and other HDHomeRun-compatible players). This policy
sets out, in plain terms, what MediaHelm Live is, what it is not, and how it must be used.
...
## MediaHelm Live supplies no content

MediaHelm Live does **not** supply, host, sell, resell, stream, aggregate, index, scrape or
provide access to any television channels, films, live streams, playlists, guide
data or subscriptions of any kind. MediaHelm Live ships empty — no pre-loaded sources, no
...
## What MediaHelm Live actually does

MediaHelm Live is interoperability software. It takes a source you already have — your own
...
HDHomeRun hardware, Plex DVR, Channels DVR and Emby Live TV. MediaHelm Live originates
nothing; it is a format bridge between a source you supply and a player you own.

## Your responsibilities

- You may only use MediaHelm Live with content and sources that you own or are otherwise
...
- You are solely responsible for the legality of every source you connect and every
  item you play through MediaHelm Live.
- You must not use MediaHelm Live to infringe copyright, to circumvent access controls or
  geographic restrictions, or to breach the terms of any third-party service.
- You must not use MediaHelm Live to redistribute, resell, retransmit or make content
...
- Using MediaHelm Live with pirated, infringing or otherwise unlawfully obtained sources.
...
this policy or applicable law. MediaHelm Live is a licensed software tool; the licence does
